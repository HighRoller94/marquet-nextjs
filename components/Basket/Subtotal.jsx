  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className={`${
          step === 2 ? "flex" : "sticky"
        } flex-col top-44 ml-8 bg-white p-8 border border-neutral-200 w-full mt-2 min-w-[375px] md:max-w-[375px]`}
      >
      ...
      <div className="bg-neutral-100 flex gap-4 items-center w-full min-w-[375px] md:max-w-[375px]  ml-8 justify-center py-4 mt-4">
        ...
        <p className="opacity-60 text-sm">All of our packaging is 100% recyclable.</p>
      </div>
    </div>
  );
}
