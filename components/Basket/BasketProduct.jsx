  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="bg-neutral-900 outline-none border-none py-2.5 px-3 md:p-3 md:px-4 w-full text-xs md:base text-neutral-50 font-semibold uppercase tracking-widest my-5 hover:opacity-90 cursor-pointer"
      >
        Remove
      </button>
    </motion.div>
