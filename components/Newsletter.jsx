        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-neutral-500">
              Sign up to our newsletter and we'll let you know when our next big sales hit, as well as more exclusive goodies.
            </p>
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none bg-neutral-800 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:opacity-90"
              >
                Subscribe
              </button>
            </div>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dt className="mt-4 font-semibold text-neutral-800">Weekly Promotions</dt>
              <dd className="mt-2 leading-7 text-neutral-500">
                Non laboris consequat cupidatat laborum magna. Eiusmod non irure
                cupidatat duis commodo amet.
              </dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-neutral-800 p-2 ring-1">
                <svg
                  className="h-6 w-6 text-white"
                  fill="none"
                  viewBox="0 0 24 24"
