    ...
    >
      {CarouselContent?.map((slide, i) => (
        <div className="w-full h-full relative">
          <div className="relative w-full h-[500px] bg-neutral-200 after:absolute after:w-full after:h-full after:top-0 after:left-0 after:bg-neutral-900 after:opacity-20">
            <Image
              fill
              src={slide.imageSrc}
              alt="Slide Image"
          ...
          <div className="p-2 rounded-lg absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-10/12 flex flex-col items-center justify-center text-center -mt-4">
            <h1 className="mt-4 font-extrabold text-white text-5xl capitalize leading-tight lg:text-6xl">{slide.header}</h1>
