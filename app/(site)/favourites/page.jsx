    ...
    <div className="mx-auto w-full flex flex-col max-w-[1250px] px-4 lg:px-6 xl:px-0 mt-6">
      ...
      <div className="flex flex-col items-center justify-center mb-8 md:my-6">
        <div className="flex items-center justify-center my-3">
          <HiHeart size={30} className="mr-3 lg:mr-4 text-neutral-700"/>
          <h1 className="font-bold text-xl md:text-3xl font-extrabold uppercase tracking-wide text-neutral-700">Saved Items</h1>
        </div>
